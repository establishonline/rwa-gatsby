					...
					<div className='row'>
						<div className='basis-full max-w-full shrink-0'>
							<div className='child:mb-4'>
								...
								<p>
									At RWadhwaAndAssociates.com, accessible from
									https://rwadhwaandassociates.com, one of our main priorities
									is the privacy of our visitors. This Privacy Policy document
									contains types of information that is collected and recorded
									by RWadhwaAndAssociates.com and how we use it.
								</p>
								...
								<p>
									...
									RWadhwaAndAssociates.com. This policy is not applicable to any
								...
								<h2 className='text-lg text-blue font-bold'>
								...
								<p>
									RWadhwaAndAssociates.com follows a standard procedure of using
								...
								<p>
									...
									of the advertising partners of RWadhwaAndAssociates.com.
								</p>
								...
								<p>
									...
									RWadhwaAndAssociates.com, which are sent directly to users'
								...
								<p>
									Note that RWadhwaAndAssociates.com has no access to or control
								...
								<p>
									RWadhwaAndAssociates.com's Privacy Policy does not apply to
								...
								<p>
									RWadhwaAndAssociates.com does not knowingly collect any
